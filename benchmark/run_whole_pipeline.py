...
# For random generated Quantum Circuits
#M_plots.generate_time_nr_qubits_plots_for_random(df)

# For the MQT Benchmark Quantum Circuits
#M_plots.generate_time_time_method_plots(df)
M_plots.generate_time_time_method_plots_for_all_benchmarks(df)

#M_plots.generate_time_time_per_node_plots(df)

#M_plots.generate_time_time_precision_plots(df)

#M_plots.generate_norm_norm_method_plots(df)

#M_plots.generate_norm_norm_precision_plots(df)

#M_plots.generate_time_nr_qubits_plots_for_all_benchmarks(df)
