...
qreg q[4];
creg meas[4];
u3(2.1921884,0,-pi) q[0];
u3(3.1145136,0,-pi) q[1];
cz q[0],q[1];
u3(0.22206511,0,-pi) q[2];
cz q[0],q[2];
cz q[1],q[2];
u3(0.66831401,-pi,0) q[3];
cz q[0],q[3];
ry(4.38406432972642) q[0];
cz q[1],q[3];
ry(3.06264293605484) q[1];
cz q[2],q[3];
ry(3.97175801110219) q[2];
ry(0.129216928142821) q[3];
