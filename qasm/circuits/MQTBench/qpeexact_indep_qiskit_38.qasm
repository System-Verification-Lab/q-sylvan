...
h q[36];
x psi[0];
cp(0.30854418) psi[0],q[0];
cp(0.61708836) psi[0],q[1];
cp(1.2341767) psi[0],q[2];
cp(2.4683534) psi[0],q[3];
cp(-1.3464784) psi[0],q[4];
cp(-2.6929569) psi[0],q[5];
cp(0.89727152) psi[0],q[6];
cp(1.794543) psi[0],q[7];
cp(-2.6940992) psi[0],q[8];
cp(0.89498685) psi[0],q[9];
cp(1.7899737) psi[0],q[10];
cp(-2.7032379) psi[0],q[11];
cp(0.87670953) psi[0],q[12];
cp(1.7534191) psi[0],q[13];
cp(-2.7763472) psi[0],q[14];
cp(0.73049094) psi[0],q[15];
cp(1.4609819) psi[0],q[16];
cp(2.9219638) psi[0],q[17];
cp(-0.4392578) psi[0],q[18];
cp(-0.87851559) psi[0],q[19];
cp(-1.7570312) psi[0],q[20];
cp(2.7691229) psi[0],q[21];
cp(-0.74493942) psi[0],q[22];
cp(-1.4898788) psi[0],q[23];
cp(-2.9797577) psi[0],q[24];
cp(0.32366995) psi[0],q[25];
cp(0.64733989) psi[0],q[26];
cp(1.2946798) psi[0],q[27];
cp(2.5893596) psi[0],q[28];
cp(-1.1044662) psi[0],q[29];
cp(-2.2089323) psi[0],q[30];
cp(1.8653206) psi[0],q[31];
