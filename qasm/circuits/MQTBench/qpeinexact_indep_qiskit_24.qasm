...
h q[22];
x psi[0];
cp(3.0320243) psi[0],q[0];
cp(-0.2191368) psi[0],q[1];
cp(-0.43827359) psi[0],q[2];
cp(-0.87654718) psi[0],q[3];
cp(-1.7530944) psi[0],q[4];
cp(2.7769966) psi[0],q[5];
cp(-0.72919215) psi[0],q[6];
cp(-1.4583843) psi[0],q[7];
cp(-2.9167686) psi[0],q[8];
cp(0.44964812) psi[0],q[9];
cp(0.89929624) psi[0],q[10];
cp(1.7985925) psi[0],q[11];
cp(-2.6860004) psi[0],q[12];
cp(0.91118459) psi[0],q[13];
cp(1.8223692) psi[0],q[14];
cp(-2.638447) psi[0],q[15];
cp(1.0062914) psi[0],q[16];
cp(2.0125828) psi[0],q[17];
cp(-2.2580197) psi[0],q[18];
