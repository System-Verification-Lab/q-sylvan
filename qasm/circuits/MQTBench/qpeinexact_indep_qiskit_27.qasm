...
h q[25];
x psi[0];
cp(0.20473798) psi[0],q[0];
cp(0.40947597) psi[0],q[1];
cp(0.81895193) psi[0],q[2];
cp(1.6379039) psi[0],q[3];
cp(-3.0073776) psi[0],q[4];
cp(0.26843016) psi[0],q[5];
cp(0.53686032) psi[0],q[6];
cp(1.0737206) psi[0],q[7];
cp(2.1474413) psi[0],q[8];
cp(-1.9883028) psi[0],q[9];
cp(2.3065798) psi[0],q[10];
cp(-1.6700257) psi[0],q[11];
cp(2.9431339) psi[0],q[12];
cp(-0.39691753) psi[0],q[13];
cp(-0.79383506) psi[0],q[14];
cp(-1.5876701) psi[0],q[15];
cp(3.1078451) psi[0],q[16];
cp(-0.067495155) psi[0],q[17];
cp(-0.13499031) psi[0],q[18];
cp(-0.26998062) psi[0],q[19];
cp(-0.53996124) psi[0],q[20];
cp(-1.0799225) psi[0],q[21];
cp(-11*pi/16) psi[0],q[22];
cp(5*pi/8) psi[0],q[23];
cp(-3*pi/4) psi[0],q[24];
cp(pi/2) psi[0],q[25];
swap q[0],q[25];
h q[0];
swap q[1],q[24];
