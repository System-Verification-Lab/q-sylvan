...
qreg q[2];
creg meas[2];
ry(0.972808329529561) q[0];
ry(0.243525227980205) q[1];
cx q[0],q[1];
ry(0.218155648135385) q[0];
ry(0.952182249259149) q[1];
cx q[0],q[1];
ry(0.805259067230613) q[0];
ry(0.465506510772893) q[1];
cx q[0],q[1];
ry(0.948917881321927) q[0];
ry(0.443025105434248) q[1];
barrier q[0],q[1];
measure q[0] -> meas[0];
measure q[1] -> meas[1];
